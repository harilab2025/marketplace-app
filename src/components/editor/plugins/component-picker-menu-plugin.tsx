...
export function ComponentPickerMenuPlugin({
  ...
  const options = useMemo<MenuOption[]>(() => {
    if (!queryString) {
      return baseOptions as MenuOption[]
    }
  ...
  const onSelectOption = useCallback(
    (
      ...
      editor.update(() => {
        nodeToRemove?.remove();
        // Cast option to ComponentPickerOption to access custom fields
        (option as ComponentPickerOption).onSelect(matchingString, editor, showModal);
        closeMenu();
      });
    },
    [editor, showModal]
