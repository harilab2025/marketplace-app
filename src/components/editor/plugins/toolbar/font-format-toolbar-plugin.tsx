...
export function FontFormatToolbarPlugin({
  ...
  return (
    <Toggle
      aria-label="Toggle text formatting"
      variant="outline"
      title={format === "bold" ? "Bold" : format === "italic" ? "Italic" : format === "underline" ? "Underline" : format === "strikethrough" ? "Strikethrough" : format === "code" ? "Code" : undefined}
      type="button"
      size="sm"
